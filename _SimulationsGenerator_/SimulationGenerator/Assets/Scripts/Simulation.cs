...
//////////////
// EX JOBB //////////////////////////////////////////////////////////////////////////////////////////////////////
            listener.OnStart(this, System.IO.Path.Combine(Simulation.OutputRoot, parameters.OutRecordPath));
//////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
		}
    }
    ...
    private void GenerateObjects(ObjectsType type) {
        ...
        for (int i = 0; i < this.Parameters.N; i++) {
            ...
            GameObject cube;
                cube = Object.Instantiate(type != ObjectsType.Spheres ? this.Parameters.CubePrefab : this.Parameters.SpherePrefab);
